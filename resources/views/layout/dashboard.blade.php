...
<div class="page">
                    ...
                    <div class="rd-navbar-aside">
                        ...
                        <div class="rd-navbar-aside-item">
                            <div class="block-inline">
                                <a href="{{ url('logout') }}" class="unit unit-spacing-xs align-items-center">Desconectar</a>
                            </div>
                    ...
                    <div class="rd-navbar-main">
                        ...
                        <div class="rd-navbar-nav-wrap">
                            ...
                            <ul class="rd-navbar-nav">
                                ...
                                <li class="rd-nav-item"><a class="rd-nav-link" href="{{url('prospect')}}">Prospecção</a>
                                    <ul class="rd-menu rd-navbar-dropdown">
                                        <li class="rd-dropdown-item"><a class="rd-dropdown-link" href="{{url('prospect')}}">Passivos</a></li>
    ...
    <section class="breadcrumbs-custom bg-image context-dark" data-opacity="28" style="background-image: url(images/breadcrumbs-bg-07-1920x420.jpg);">
        <div class="container">
            <h2 class="breadcrumbs-custom-title">Its Home Imobiliária</h2>
        </div>
    </section>
...
{{--                                        <label class="form-label" for="property-contato">Digite o endereço do sites</label>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
