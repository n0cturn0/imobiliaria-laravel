...
@section('lancamento-edita-informacao')
        ...
        <div class="col-md-9 col-lg-7 col-xl-5">
          ...
          <form class="rd-form rd-mailform" data-form-output="form-output-global"  method="post" action="{{url('atualiza-imovel')}}">
           ...
           @foreach ($lancamento as $item)
              ...
              <div class="col-12">
                <div class="form-wrap">
                  <input class="form-input" readonly value="{{$item->titulo}}" id="contact-name" placeholder="Nome do lançamento" type="text" name="nome" data-constraints="@Required">
                </div>
              </div>
